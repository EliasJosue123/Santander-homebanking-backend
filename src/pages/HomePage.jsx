  ...
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    <defs>
      <linearGradient id="g-mis" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#ec0000" />
  ...
  <svg className="carrusel__svg" viewBox="0 0 1000 640" preserveAspectRatio="xMidYMid slice">
    <defs>
      <linearGradient id="g-pad" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#cc0000" />
        <stop offset="0.55" stopColor="#ec0000" />
        <stop offset="1" stopColor="#ff3333" />
      </linearGradient>
    </defs>
...
const SLIDES = [
  {
    ...
    subtitulo: 'Contribuir al progreso de las personas y de las empresas.',
    svg: <img src="/carrucel1.jpg" alt="" className="carrusel__svg" style={{ objectFit: 'cover', filter: 'brightness(0.5)' }} />,
  },
  {
    badge: 'Nuestra esencia',
    titulo: 'Nuestra visión',
    subtitulo: 'Ser el mejor banco comercial ganándonos la confianza y la fidelidad de nuestros empleados, clientes, accionistas y de la sociedad.',
    svg: <img src="/carrucel2.jpg" alt="" className="carrusel__svg" style={{ objectFit: 'cover', filter: 'brightness(0.5)' }} />,
  },
  {
    badge: 'Nuestra esencia',
    titulo: 'Cómo hacemos las cosas',
    subtitulo: 'Todo lo que hacemos ha de ser siempre Sencillo, Personal y Justo.',
    svg: <img src="/carrucel3.jpg" alt="" className="carrusel__svg" style={{ objectFit: 'cover', filter: 'brightness(0.5)' }} />,
  }
]
  ...
  return (
    <div className="home">
      ...
      <footer className="home-footer-bar">
        <span>© 2026 Banco Santander · Core Financiero — Sistema interno</span>
        <span>
